...
class CombinedAPI(SystemAPI, InferenceAPI, BundlesAPI, GalleryAPI, StylesAPI, SettingsAPI, metaclass=ApiMeta):
    ...
    def __init__(self, service, inference, bundle_store, db, config) -> None:
