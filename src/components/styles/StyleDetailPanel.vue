  ...
  <div class="flex flex-col h-full gap-4">
    ...
    <div>
      ...
      <div class="flex items-center gap-3">
        <!-- Thumbnail preview -->
        <div class="flex items-center justify-center flex-shrink-0 w-12 h-12 overflow-hidden rounded bg-surface-800">
        ...
        <div class="flex gap-2">
          ...
          <Button v-if="style.thumbnailPath" @click="emit('thumbnail-removed')" severity="danger" variant="outlined" size="small">
    ...
    <div>
      <div class="flex items-center justify-between mb-2">
        ...
        <Button @click="emit('addLora')" severity="secondary" variant="text" size="small">
      ...
      <div v-else class="flex flex-col gap-2">
        <div v-for="lora in style.loras" :key="lora.loraId" class="flex items-center justify-between p-2 rounded bg-surface-800">
          ...
          <div class="flex items-center gap-2 ml-2">
            ...
            <Button @click="emit('removeLora', lora.loraId)" severity="danger" variant="text" size="small" class="!p-1">
