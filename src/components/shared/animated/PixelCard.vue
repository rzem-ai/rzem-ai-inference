<template>
  <div
    ref="containerRef"
    :class="[
      'h-100 w-75 relative overflow-hidden grid place-items-center aspect-4/5 border border-[#27272a] rounded-[25px] isolate transition-colors duration-200 ease-[cubic-bezier(0.5,1,0.89,1)] select-none',
      className,
    ]"
    ...
    <canvas class="block w-full h-full" ref="canvasRef" />
