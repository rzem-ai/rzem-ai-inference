<template>
  <div class="flex h-full bg-surface-900">
    ...
    <aside class="flex flex-col h-full border-r bg-surface-900 border-surface-700 w-105 min-w-80">
      <div class="px-4 py-4 border-b border-surface-700">
        <h1 class="m-0 text-lg font-semibold text-surface-100">Model Manager</h1>
      </div>
          ...
          <div v-if="group.models.length > 0" class="py-2">
            ...
            <div
              ...
              <div class="shrink-0">
                ...
                <span
                  v-else
                  class="flex items-center justify-center w-6 h-6 rounded-full text-surface-400 bg-surface-700">
    ...
    <main class="flex-1 h-full p-6 overflow-y-auto bg-surface-950">
      <template v-if="selectedModel">
        ...
        <div v-if="selectedModel.category === 'component' && selectedModel.hasQuantized" class="mb-6">
          ...
          <div class="p-4 rounded-lg bg-surface-800">
            ...
            <p v-if="selectedModel.quantizedDownloaded" class="m-0 mt-2 text-xs text-surface-500">
              Using quantized version for reduced VRAM usage.
            </p>
            <p v-else class="m-0 mt-2 text-xs text-surface-500">
