  ...
  async get_bundle_types() {
    return {
      ...
      bundle_types: [
        ...
        { id: "flux1_kontext", label: "FLUX.1 Kontext", icon: "gpu", guide: "## Editing\n\nFLUX.1 Kontext [dev] edits images from a **text prompt + input image**.", sort_order: 1 },
        ...
        { id: "qwen_image", label: "Qwen-Image", icon: "gpu", guide: "## Prompting\n\nQwen-Image excels at **text rendering in images**.", sort_order: 4 },
    ...
    return {
      ...
      bundles: [
        ...
        },
        {
          ...
          label: "FLUX.1 Kontext Dev — Quality",
          description: "FLUX.1-Kontext-dev BF16 full precision (mock)",
