<template>
  <div
    ref="containerRef"
    :class="[
      'h-12 w-12 relative overflow-hidden grid place-items-center bg-surface-700 border border-blue-900 rounded-xl isolate transition-colors duration-200 ease-[cubic-bezier(0.5,1,0.89,1)] select-none',
      className,
    ]">
